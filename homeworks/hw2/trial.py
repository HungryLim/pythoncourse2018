...
with open('hw2_lim.csv', 'wb') as f:
    ...
    while still_petitions:
        ...
        print i
            all_petition = all_html.find_all('div', {'class':"field field-name-field-petition-issues field-type-taxonomy-term-reference field-label-hidden tags"})
            all_petition = all_html.find_all("h3")[4]
            all_petition[4]
