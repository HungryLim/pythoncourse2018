...
import random
def random_product(lower, upper):
	random1=random.uniform(lower, upper) #using function, uniform.
...
me.latin_name #access the attribute in class
you.latin_name
...
me.introduce() #example of introduce
...
class Senator():
  ...
  def vote(self, bill, choice):
    ...
    print self.name + " voets " + choice + " on " + bill.title
